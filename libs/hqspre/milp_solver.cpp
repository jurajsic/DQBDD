...
GlpkSolver::VarType
GlpkSolver::addVariable(MilpSolver::VarSort sort, bool lower_bounded, double lower_bound, bool upper_bounded,
                        double upper_bound)
{
...
void
GlpkSolver::setObjectiveDirection(MilpSolver::ObjectiveType dir)
{
...
void
GlpkSolver::setObjective(const std::vector<MilpSolver::VarType>& variables, const std::vector<double>& coeffs)
{
...
double
GlpkSolver::getObjectiveValue()
{
    return glp_get_obj_val(_solver);
}

void
GlpkSolver::addConstraint(const std::vector<MilpSolver::VarType>& variables, const std::vector<double>& coeffs,
...
TruthValue
GlpkSolver::solve(void (*callback)(glp_tree*, void*), void* info)
{
    glp_smcp lp_opt;
...
int
GlpkSolver::getIntValue(MilpSolver::VarType var)
{
    return static_cast<int>(std::round(glp_mip_col_val(_solver, var)));
}

double
GlpkSolver::getDoubleValue(MilpSolver::VarType var)
{
