 ...
 */
inline bool
Clause::empty() const noexcept
{
    return _literals.empty();
}

/**
 * \brief Returns a read-only iterator pointing to the first literal and
 * providing read access.
 */
inline Clause::const_iterator
Clause::cbegin() const noexcept
{
 ...
 */
inline Clause::const_iterator
Clause::begin() const noexcept
{
    return _literals.begin();
}

/**
 * \brief Returns a read-only iterator pointing beyond the last literal and
 * providing read access.
 */
inline Clause::const_iterator
Clause::cend() const noexcept
{
 ...
 */
inline Clause::const_iterator
Clause::end() const noexcept
{
    return _literals.end();
}

/**
 * \brief Returns a read-only reverse iterator pointing to the last literal of
 * the clause.
 */
inline Clause::const_reverse_iterator
Clause::crbegin() const noexcept
{
    return _literals.crbegin();
}

/**
 * \brief Returns a read-only reverse iterator pointing before the first literal
 * of the clause.
 */
inline Clause::const_reverse_iterator
Clause::crend() const noexcept
{
 ...
 */
inline Clause::const_reverse_iterator
Clause::rend() const noexcept
{
    return _literals.rend();
}

/**
 * \brief Returns an iterator pointing to the first literal and providing read
 * and write access.
 */
inline Clause::iterator
Clause::begin() noexcept
{
    return _literals.begin();
}

/**
 * \brief Returns an iterator pointing beyond the last literal and providing
...
/**
 * \brief Returns a reverse iterator pointing to the last literal and providing
 * read and write access.
 */
inline Clause::reverse_iterator
Clause::rbegin() noexcept
{
    return _literals.rbegin();
}

/**
 * \brief Returns a reverse iterator pointing before the first literal and
 * providing read and write access.
 */
inline Clause::reverse_iterator
Clause::rend() noexcept
{
    return _literals.rend();
}
 ...
 */
inline Literal
Clause::back() const noexcept
{
    return _literals.back();
}

inline const Clause::ClauseData&
Clause::getLiterals() const noexcept
{
    return _literals;
}
 ...
 */
inline bool
Clause::operator==(const Clause& other) const noexcept
{
 ...
 */
inline ClauseStatus
Clause::getStatus() const noexcept
{
    return _status;
}
 ...
 */
inline void
Clause::setStatus(const ClauseStatus new_status) noexcept
{
    _status = new_status;
}
 ...
 */
inline std::uint64_t
Clause::getSignature() const noexcept
{
    return _signature;
}

/**
 * \brief Returns the signature of a clause w.r.t. the variables appearing in
 * the clause.
 *
 * This signature is used for efficiently excluding candidates
 * of subsumption.
 */
inline std::uint32_t
Clause::getVarSignature() const noexcept
{
 ...
 */
inline bool
Clause::isMarked() const noexcept
{
    return _marked != 0;
}
 ...
 */
inline bool
Clause::isMarked(const unsigned int pos) const noexcept
{
    val_assert(pos < 32);
    return static_cast<bool>(_marked & (1u << pos));
}
 ...
 */
inline void
Clause::mark(const unsigned int pos) const noexcept
{
    val_assert(pos < 8);
    _marked |= (1u << pos);
}
 ...
 */
inline void
Clause::unMark(const unsigned int pos) const noexcept
{
    val_assert(pos < 8);
 ...
 */
inline BinaryClause::BinaryClause(const Literal lit, const ClauseID c_nr) noexcept : _literal(lit), _clause_id(c_nr)
{}
 ...
 */
inline bool
BinaryClause::operator==(const BinaryClause& other) const noexcept
{
 ...
 */
inline Literal
BinaryClause::getLiteral() const noexcept
{
    return _literal;
}
 ...
 */
inline ClauseID
BinaryClause::getClauseID() const noexcept
{
    return _clause_id;
}
