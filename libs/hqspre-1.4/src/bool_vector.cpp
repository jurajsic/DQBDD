...
/**
 * \brief Flips all values in the bit vector and returns the result as a new BoolVector
 * \sa BoolVector::flip()
 */
...
/**
 * \brief Performs entry-wise logical AND of the current vector and the one passed as parameter.
 *
...
/**
 * \brief Performs entry-wise logical OR of the current vector and the one passed as parameter.
 *
 * The result is stored in the current vector (which is also returned).
 * \pre The size of the current vector and the passed vector must be the same.
 */
...
/**
 * \brief Performs entry-wise logical XOR of the current vector and the one passed as parameter.
 *
 * The result is stored in the current vector (which is also returned).
 * \pre The size of the current vector and the passed vector must be the same.
 */
