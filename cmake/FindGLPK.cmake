...
if(GLPK_FOUND)
  ...
  set(GLPK_COMPILE_FLAGS "${GLPK_INCLUDE_DIRS}"
    CACHE STRING "Compile flags used when compiling GLPK programs")
  set(GLPK_LIBRARIES ${GLPK_LIBRARIES}
    CACHE STRING "Libraries used when linking GLPK programs")
else(GLPK_FOUND)
